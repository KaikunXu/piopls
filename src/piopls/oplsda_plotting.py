...
class OPLSDA_Visualizer:
    ...
    def __init__(
        ...
        """Initializes the visualizer with the model and settings.
    ...
    def plot_all(self, perm_results=None, save_path=None):
        ...
        try:
            ...
            max_len = df_top['Feature'].astype(str).str.len().max()
    ...
    def plot_score(self, ax=None):
        ...
        Visualizes the Predictive vs 1st Orthogonal T-score.
        ...
        sns.scatterplot(
            data=df_scores, x='t_pred', y='t_ortho_1_plot', hue='Class', 
    ...
    def plot_splot(self, ax=None):
        ...
        sns.scatterplot(
            data=df_feat, x='Covariance', y='Correlation', hue='Cat', 
    ...
    def plot_vip_bar(self, ax=None):
        ...
        df_top['Color'] = df_top['Correlation'].apply(
            lambda c: 'tab:red' if c > 0 else 'tab:blue'
        )
        
        bars = ax.barh(
            df_top['Feature'], df_top['VIP'], color=df_top['Color'], 
